# Table of contents
* [Welcome](README_OIM.md)
* [Welcome](README_OM4ADO.md)
...
* [Manage](docs/manage/manage.md)
    * [Administrator](docs/manage/administrator.md)
        ...
        * [API Key Management](docs/manage/administrator/api-key-management.md)
        ...
        * [Allow Additional Classes For Processing](docs/manage/administrator/allow-additional-classes-for-processing.md)
    ...
    * [MCP Server](docs/manage/mcp.md)
        * [Get Started](docs/manage/mcp/getting-started-with-mcp.md)
        * [Configuration](docs/manage/mcp/mcp-configuration.md)
        * [Available Tools](docs/manage/mcp/mcp-available-tools.md)
        * [MCP Capability Matrix](docs/manage/mcp/mcp-capability-matrix.md)
        * [Sample Use Cases](docs/manage/mcp/mcp-sample-use-cases.md)
            * [Integration Health Monitoring](docs/manage/mcp/mcp-use-case-integration-healthcheck.md)
            * [Create Mapping Between Systems](docs/manage/mcp/mcp-use-case-create-mapping.md)
