...
* [Manage](docs/manage/manage.md)
    ...
    * [MCP Server](docs/manage/mcp.md)
        ...
        * [Sample Use Cases](docs/manage/mcp/mcp-sample-use-cases.md)
            * [Query Configured Systems and Project Pairs](docs/manage/mcp/mcp-use-case-get-systems-and-projects.md)
            * [Integration Health Check](docs/manage/mcp/mcp-use-case-integration-healthcheck.md)
