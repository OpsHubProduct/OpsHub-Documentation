...
When Codebeamer/CodebeamerX is the target system in OpsHub Integration Manager, the following limitations may be observed when synchronizing Rich Text fields:
