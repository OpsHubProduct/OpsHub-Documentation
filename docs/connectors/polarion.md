...
* **Enable Apache Axis Support for Polarion:**
    
   To connect <code class="expression">space.vars.OIM</code> with Polarion, you need to add a required library in Polarion instance.
