...
* For synchronizing the **Jira Service Management** entities, ensure that the following prerequisites and scopes are configured based on the selected authentication mode for Jira System:
